    ...
    public partial class FormInicio : Form
    {
        ...
        public void clickDepo(Panel depo, PictureBox depoElim)
        {
            ...
            else
            {
                ...
                Program.Blank.Depo.pbDepoLogo.Image = Logica.conByteImg(Convert.FromBase64String(depoInfo[4,0]));
                if (depoInfo[2, 0] == 0) tipo = "Individual";
                else tipo = "Equipo";
                
                Program.Blank.Depo.lblInfoDepo.Text = 
                    "Deporte : "+depo.Name+"\n" +
                    "Nombre Corto : "+ depoInfo[1, 0] + "\n"+
                    "Tipo de deporte : "+tipo+"\n" +
                    "Numero de Titulares : "+ depoInfo[3, 0];
                Program.Blank.Depo.lblDepoInfo.Text = depoInfo[5, 0]+"";
        ...
        public void cargaDepo()
        {
            ...
            for (int i = 0; i < Logica.consultaMaxIndex("Select * from deporte"); i++)
            {
                ...
                imgDepo.Image = Logica.conByteImg(Convert.FromBase64String(depoInfo[4,i]));

                Label nomCorto = new Label();
                nomCorto.Parent = depo;
                nomCorto.Text = depoInfo[1, i];
        ...
        public void cargaTorn()
        {
            ...
            for (int i = 0; i < Logica.consultaMaxIndex("Select * from torneo"); i++)
            {
                ...
                imgTorn.Image = Logica.conByteImg(Convert.FromBase64String(tornInfo[5, i]));
