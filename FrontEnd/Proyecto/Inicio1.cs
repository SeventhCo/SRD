...
namespace Proyecto
{
    public partial class FormInicio : Form
    {
        ...
        {
            string tipo;
            dynamic[,] depoInfo = JsonConvert.DeserializeObject<dynamic[,]>(ApiAux.consulta("Select * from deporte WHERE nombreDep = '" + depo.Name + "'"));
            Program.Blank.Depo.pbDepoLogo.Image = Imagen.conByteImg(Convert.FromBase64String(depoInfo[5, 0]));
        ...
        public void cargaDepo()
        {
            ...
            cantDepo = 0;
            Retorno ret = JsonConvert.DeserializeObject<Retorno>(ApiAux.consultaMaxIndex("Select * from deporte"));
            for (int i = 0; i < ret.result; i++)
            {
                dynamic[,] depoInfo = JsonConvert.DeserializeObject<dynamic[,]>(ApiAux.consulta("Select * from deporte"));
                ...
                imgDepo.Image = Imagen.conByteImg(Convert.FromBase64String(depoInfo[5,i]));
        ...
        public void cargaTorn()
        {
            ...
            cantTorn = 0;
            Retorno ret = JsonConvert.DeserializeObject<Retorno>(ApiAux.consultaMaxIndex("Select * from torneo"));
            for (int i = 0; i < ret.result; i++)
            {
                dynamic[,] tornInfo = JsonConvert.DeserializeObject<dynamic[,]>(ApiAux.consulta("Select * from torneo"));
                ...
                imgTorn.Image = Imagen.conByteImg(Convert.FromBase64String(tornInfo[5, i]));
        ...
        public void cargaEqui()
        {
            ...
            cantEqui = 0;
            Retorno ret = JsonConvert.DeserializeObject<Retorno>(ApiAux.consultaMaxIndex("Select * from equipo"));
            for (int i = 0; i < ret.result ; i++)
            {
                dynamic[,] equiInfo = JsonConvert.DeserializeObject<dynamic[,]>(ApiAux.consulta("Select * from equipo"));
                ...
                imgEqui.Image = Imagen.conByteImg(Convert.FromBase64String(equiInfo[2, i]));
        ...
        private void loginClick()
        {
            ...
            if (loged)
            {
                dynamic[,] datosUsuario = JsonConvert.DeserializeObject<dynamic[,]>(ApiAux.consulta("Select * from usuario WHERE gmail = '" + Program.Blank.user.gmail[0] + "' AND dominio = '" + Program.Blank.user.gmail[1] + "'"));
