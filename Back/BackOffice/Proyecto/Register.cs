    ...
    public partial class Register : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if ((int.TryParse(textBox4.Text, out dia) && dia > 0 && dia < 32 && int.TryParse(textBox6.Text, out mes) && mes > 0 && mes < 13 && int.TryParse(textBox7.Text, out ano) && ano >= 1900))
            {
                ...
                else if (lblUsuarioSubscriptoRegister.Checked) rol = 1;
                else rol = 0;
        ...
        private void checkBox1_Click(object sender, EventArgs e)
        {
            if (lblAdmin.Checked)
            {
                lblUsuarioSubscriptoRegister.Checked = false;
            }
        }
        ...
        {
            if (lblUsuarioSubscriptoRegister.Checked)
            {
                lblAdmin.Checked = false;
            }
        }
