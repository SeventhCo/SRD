...
primary key(id,nombreEqu,nombreFase)
);
...
remplazoId int,
remplazoE varchar(30),
remplazoN int,
remplazoFase varchar(50),
minuto time,

primary key (id,nombreEqu,numero,nombreFase),
foreign key (id,nombreEqu,nombreFase) references equiposEvento(id,nombreEqu,nombreFase) on delete cascade	on update cascade,
foreign key (nombreEqu,numero) references deportistaEquipo(nombreEqu,numero) on delete cascade	on update cascade,
foreign key (remplazoId,remplazoE,remplazoN,remplazoFase) references Alineacion(id,nombreEqu,numero,nombreFase) on delete cascade	on update cascade
);
...
foreign key (id,nombreEqu,numero,nombreFase) references Alineacion(id,nombreEqu,numero,nombreFase) on delete cascade	on update cascade,
primary key (id,nombreEqu,numero,nombreFase,idSuceso)
);

create table publicidad(
pais varchar(30),
tipo bool not null, #banner 1 sky 0
